...
#pragma warning restore CS0618 // 类型或成员已过时
        ...
        #region Log方法
        public void Log(LogEventInfo logEvent) => _logger.Log(logEvent);

        public void Log(Type wrapperType, LogEventInfo logEvent) => _logger.Log(wrapperType, logEvent);

        public void Log<T>(LogLevel level, T value) => _logger.Log(level, value);

        public void Log<T>(LogLevel level, IFormatProvider formatProvider, T value) => _logger.Log(level, formatProvider, value);
