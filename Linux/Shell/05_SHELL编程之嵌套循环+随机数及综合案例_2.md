...
**需求3：**shell脚本和expect结合使用，在<font color=#FF0000>多台服务器</font>上创建1个用户
...
写一个脚本，将跳板机上yunwei用户的公钥推送到<font color=#FF0000>局域网内</font>可以ping通的所有机器上
...
功能2：判断主机是否ping通并且<font color=#FF0000>yunwei用户</font>推送公钥
...
2. 如何统计<font color=#FF0000>不同的</font>状态   循环去统计，需要计算
